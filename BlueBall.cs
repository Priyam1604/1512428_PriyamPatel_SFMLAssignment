...
using SFML.System;
    ...
    public class BlueBall : CircleShape
    {
        private RectangleShape ballLink;
        private Vector2f velocity;
        private float linkWidth;
        private Color lineFillColour;
        public int displValue = 0;
        public BlueBall(Color fillColour, Color lineColour,int randomnum, float radius = 30, int pointCount = 30, int lineWidth = 1) : base(radius, (uint)pointCount)
        {
            this.ballLink = null;
            this.velocity = new Vector2f(0, 0);
           
            this.lineFillColour = Color.Yellow;
            this.linkWidth = 8;
            this.displValue = randomnum;
